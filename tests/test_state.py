...
class TestState(unittest.TestCase):
    ...
    def setUp(self):
        self.obj = State()
        self.obj.name = "Banjul"

    # Testing formats
    def test_date_time_format_valid(self):
        self.assertEqual(State.DATE_TIME_FORMAT, r"%Y-%m-%dT%H:%M:%S.%f")

    def test_date_time_format_invalid(self):
        format = State.DATE_TIME_FORMAT
    ...
    # Testing types
    def test_typeof_State_model_instance_id(self):
        self.assertIsInstance(self.obj.id, str)

    def test_typeof_State_model_instance_created_at(self):
        self.assertIsInstance(self.obj.created_at, datetime)

    def test_typeof_State_model_instance_updated_at(self):
        self.assertIsInstance(self.obj.updated_at, datetime)

    def test_typeof_State_model_instance_name(self):
        self.assertIsInstance(self.obj.name, str)

    def test_typeof_State_model_instance_to_dict_equal(self):
        self.assertIsInstance(self.obj.to_dict(), dict)

    def test_typeof_State_model_instance_to_dict_not_equal(self):
        self.assertNotIsInstance(self.obj.to_dict(), str)

    # Testing values
    def test_value_of_State_model_instance_id(self):
        id = self.obj.id
        self.assertEqual(id, self.obj.id)

    def test_value_of_State_model_instance_created_at(self):
        created_at = self.obj.created_at
        self.assertEqual(created_at, self.obj.created_at)

    def test_value_of_State_model_instance_updated_at(self):
